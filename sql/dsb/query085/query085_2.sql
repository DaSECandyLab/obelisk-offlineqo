 ...
 where ws_web_page_sk = wp_web_page_sk
   ...
   or
    (
     ...
     customer_demographics1.cd_marital_status = customer_demographics2.cd_marital_status
     and
     customer_demographics1.cd_education_status = 'Primary'
     and
     customer_demographics1.cd_education_status = customer_demographics2.cd_education_status
     and
   ...
   or
    (
     customer_demographics1.cd_marital_status = 'W'
     and
     customer_demographics1.cd_marital_status = customer_demographics2.cd_marital_status
     and
     customer_demographics1.cd_education_status = '4 yr Degree'
     and
     customer_demographics1.cd_education_status = customer_demographics2.cd_education_status
     and
